...
const AboutSection = () => {
  ...
  return (
    <section className="py-12 sm:py-16 lg:py-24 section-dark relative">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="bg-card rounded-2xl sm:rounded-3xl p-6 sm:p-8 md:p-12 lg:p-16 relative overflow-hidden">
          ...
          <div className="grid md:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-start">
            ...
            <div className="space-y-6 sm:space-y-8">
              ...
              <div className="relative mt-8">
                <div className="flex items-center space-x-4">
                  <div className="text-muted text-sm">Neural AI Innovation</div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="bg-surface-tertiary text-primary px-3 py-1 rounded-lg text-sm font-semibold">
                  AI
                </div>
              </div>
              ...
              <div className="pt-6">
                <button className="bg-primary hover:bg-primary-hover text-primary-foreground font-semibold px-8 py-4 rounded-full flex items-center gap-3 transition-colors group">
          ...
          {/* Decorative background elements - removed gradients */}
          <div className="absolute top-0 right-0 w-64 h-64 rounded-full blur-3xl opacity-5 bg-primary"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 rounded-full blur-3xl opacity-5 bg-primary"></div>
        </div>
      </div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 w-12 h-12 bg-primary hover:bg-primary-hover text-primary-foreground rounded-full flex items-center justify-center shadow-lg transition-colors z-10"
